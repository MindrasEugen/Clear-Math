...
export default function WorkspacePage() {
  ...
  // Per ora mostriamo tutto come da fare
  const progress = 50; // TODO: Calcolare progresso reale
                ...
                <ListGroup variant="flush" className="border-0">
                  {topicExercises.map((exercise, index) => (
                    ...
                    >
                      ...
                      {/* Risposta (da implementare) */}
                      <div className="mt-2 ms-2">
                        <input
                          type="text"
                          placeholder="Inserisci risposta..."
                          className="border-0 border-bottom border-2 border-secondary rounded-0 p-1 w-100"
                          style={{
                            fontFamily: FONTS.BODY,
                            fontSize: '14px',
                            minWidth: '200px'
